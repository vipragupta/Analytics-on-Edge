...
def mypost():
    ...
    try:
        ...
        if(request.method == 'POST'):
            ...
            #response = {"Message": "Local summary data retrieved", "client_summary": {"distance": 3.4, "elevation": 2.1, "activemins": 23.0, "calories": 14131.0, "pulse": "98", "floors": 1.3, "steps": 123456, "date": "2017-04-03", "bp": 2, "id": "2222222222"}, "localAreaSummary": {"distance": 3.4, "elevation": 2.1, "activemins": 23.0, "ip": "0.0.0.0", "calories": 14131.0, "pulse": 98, "floors": 1.3, "steps": 123456, "date": "2017-04-03", "bp": "1.576923076"}, "StatusCode": 200}
